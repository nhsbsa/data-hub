...
router.post(/sign-out/, (req, res) => {
    ...
    res.redirect('/data-hub/mvp/v4-3/homepage');
});
// ===================================
// Create an account routes
// ===================================
router.post(/full-name/, (req, res) => {
    res.redirect('/data-hub/mvp/v4-3/auth/job-role');
});
router.post(/job-role/, (req, res) => {
    res.redirect('/data-hub/mvp/v4-3/auth/associated-organisation');
});
router.post(/associated-organisation/, (req, res) => {
    res.redirect('/data-hub/mvp/v4-3/auth/your-email');
});
router.post(/your-email/, (req, res) => {
    res.redirect('/data-hub/mvp/v4-3/auth/check-your-answers');
});
router.post(/auth-code/, (req, res) => {
    res.redirect('/data-hub/mvp/v4-3/auth/create-password');
});
router.post(/create-password/, (req, res) => {
    res.redirect('/data-hub/mvp/v4-3/auth/my-account');
});
// ===================================
// Entra ID (replica)
// ===================================
...
router.post(/enter-code/, (req, res) => {
    ...
    if (forgottenPassword === 'yes'){
        res.redirect('/data-hub/mvp/v4-3/auth/entra-id/update-password');
    } else {
        res.redirect('/data-hub/mvp/v4-3/auth/my-account');
    } 
});
router.post(/entra-create-account/, (req, res) => {
    const forgottenPassword = 'no'
    res.redirect('/data-hub/mvp/v4-3/auth/entra-id/create-password');
});
