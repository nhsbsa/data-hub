...
router.post(/full-name/, (req, res) => {
    res.redirect('/data-hub/mvp/v4-2/auth/job-role');
});
router.post(/job-role/, (req, res) => {
    res.redirect('/data-hub/mvp/v4-2/auth/associated-organisation');
});
router.post(/associated-organisation/, (req, res) => {
    res.redirect('/data-hub/mvp/v4-2/auth/your-email');
});
router.post(/your-email/, (req, res) => {
    res.redirect('/data-hub/mvp/v4-2/auth/check-your-answers');
});
router.post(/auth-code/, (req, res) => {
    res.redirect('/data-hub/mvp/v4-2/auth/create-password');
});
